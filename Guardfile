...
guard :rspec, cmd: "bundle exec rspec" do
  ...
  # models/concerns/act/file_name_concerns.rb
  # controller/concerns/act/file_name_concerns.rb
  watch(%r{^app/(controllers|models)/concerns/(.+)/(.+)\.rb$}) do |m|
    ("spec/#{m[1]}/#{m[2]}/#{m[3]}_spec.rb")
  end
  ...
  watch(%r{^app/services/(.+)/(.+)\.rb$}) do |m|
    ("spec/services/#{m[1]}/#{m[2]}_spec.rb")
  end
...
guard :eslint do
  ...
  watch(%r{^app/javascript/.+\.(js|jsx|es6)$})
end
